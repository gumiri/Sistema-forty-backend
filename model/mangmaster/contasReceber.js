...
async function getCtrecDate(date1, date2) {
    try {
        ...
        r.DTREMRETCONFENT, r.STWEB, r.CODITPAG, r.PARCIMPOSTOINDIVIDUAL, 'MANGMASTER' AS FILIAL
        from ctrec r
...
async function getCtrecLenthDate(date1, date2) {
    try {
...
module.exports = { getCtrecDate, getCtrecLenthDate, getCtrec, getCtrecLenth };